        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-200 bg-white mt-3">
            <nav className="px-4 py-3 space-y-3">
              <a href="#dashboard" className="block py-2 text-primary font-medium">
                <svg className="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/>
                </svg>
                Dashboard
              </a>
              <a href="#payments" className="block py-2 text-slate-600">
                <svg className="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
                </svg>
                Payments
              </a>
              <a href="#withdraw" className="block py-2 text-slate-600">
                <svg className="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#kyc" className="block py-2 text-slate-600">
                <svg className="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                </svg>
                KYC
              </a>
              <a href="#support" className="block py-2 text-slate-600">
                <svg className="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 24 24">
